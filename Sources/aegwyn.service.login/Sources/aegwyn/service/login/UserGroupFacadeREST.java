 ...
 */
/**
 * UserGroupFacadeREST.java
 *
 * Created on Mar 30, 2017, 11:37:51 AM
 */

package aegwyn.service.login;

import aegwyn.core.cred.entity.UserGroup;
 ...
 */
@Stateless 
@Path("model.entity.usergroup")
public class UserGroupFacadeREST extends AbstractFacade<UserGroup> 
{

    @PersistenceContext(unitName = "CustFeedbackLoginPU_schema_0")
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit (@PathParam("id") Integer id, UserGroup entity)
    {
        super.edit (entity);
    }
