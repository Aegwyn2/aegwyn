 ...
 * @author Benny
 */
@Stateless(name = "MultiTenant")
//@PersistenceContexts (
//    {
//        @PersistenceContext(name = "persistence/LOCATION0", unitName = "CustFeedbackLoginPU_schema_0"),
//        @PersistenceContext(name = "persistence/LOCATION1", unitName = "CustFeedbackLoginPU_schema_1"),
//        @PersistenceContext(name = "persistence/LOCATION2", unitName = "CustFeedbackLoginPU_schema_2")
//    }
//)
public class StandardMultiTenantEntityManagerWrapper implements MultiTenantEntityManagerWrapper
{
    @Resource
...
//    @EJB
    ...
    {
        EntityManager manager = (EntityManager) context.lookup(apc.getWebRequestInfo ().getPersistenceJNDILocation ());
