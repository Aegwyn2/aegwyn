 ...
 */
@Entity
@Table(name="complaintboard")
@NamedQueries({
    @NamedQuery(name = "ComplaintBoard.findAll", query = "SELECT B FROM ComplaintBoard B"),
    @NamedQuery(name = "ComplaintBoard.findByTenantId", query = "SELECT B FROM ComplaintBoard B WHERE B.tenantId = :tenantId")
})
public class ComplaintBoard extends Board
{
//    @Id
